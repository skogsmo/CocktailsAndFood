            ...
            <div className="main-wrapper">
                <div className="h-full">
                    <div className="px-8 md:px-0 text-center flex flex-col gap-5 mb-[50px]">
                        ...
                        <p className="text-lg">
                            Låt dig inspireras av vårt förslag eller valj att
                            skapa din egen unika smakresa genom att byta ut
                            rekommendationen mot en annan cocktail från vår
                            meny.
                        </p>
                    </div>
                    ...
                    {formattedDrink && (
                        <div className="w-full md:rounded-[25px] overflow-hidden bg-white shadow-custom-big">
                            <div className="w-full flex flex-col-reverse gap-10 items-center md:flex-row justify-between p-8 py-12">
                                <img
