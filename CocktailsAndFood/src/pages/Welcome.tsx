                ...
                <div className="bg-black/70 grow flex flex-col justify-center items-center">
                    <div className="text-white flex flex-col items-center text-center max-w-[1000px]">
                        ...
                        <p className="px-4 text-lg sm:text-xl mb-[50px]">
                            Upplev smakrika burrito bowls och uppfriskande
                            cocktails hos oss. Skapa din perfekta kombination av
                            smaker och låt oss guida dig på en kulinarisk resa.
                            <br /> <br />
                            Vår restaurang erbjuder enastående matupplevelser,
